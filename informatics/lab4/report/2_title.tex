  ...
  \begin{center}
    ...
    \begin{figure}[H]
      ...
      \begin{minipage}[c]{0.3\textwidth}
        \includegraphics[width=\textwidth]{logos/logo_university}
      \end{minipage}
      \hfill
      \begin{minipage}[c]{0.3\textwidth}
        \includegraphics[width=\textwidth]{logos/logo_institute}
      \end{minipage}
      \hfill
      \begin{minipage}[c]{0.3\textwidth}
        \includegraphics[width=\textwidth]{logos/logo_department}
      \end{minipage}
    \end{figure}
